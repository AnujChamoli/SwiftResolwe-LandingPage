...
export const Manifesto = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-[420px] bg-[var(--accent-bright)] opacity-[0.06] blur-[120px]" />
      <motion.div
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[var(--border-soft)] bg-[var(--bg-surface)] mb-8">
          <Cpu size={14} className="text-[var(--accent)]" />
          <span className="font-mono-ui text-[10px] tracking-[0.22em] text-[var(--accent-deep)] uppercase">
